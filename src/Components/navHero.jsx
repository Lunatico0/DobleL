...
const NavHero = () => {
  ...
  return (
    <motion.header
      ...
      className="fixed top-0 left-0 w-full z-50 bg-background/70 dark:bg-background-dark/70 backdrop-blur-md shadow-md"
    >
      <div className="max-w-6xl mx-auto flex justify-between items-center py-4 px-6">
        ...
        ><span className="font-bold text-text dark:text-text-dark">Doble L</span><span className="text-gray-600 hidden md:block pl-2">| Estudio de arquitectura</span>
        </button>
      ...
      {open && (
        <motion.nav
          ...
          className="md:hidden bg-background dark:bg-background-dark shadow-md"
        >
